...
class MessageTickerCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        title.font = UIFont(name: Assets.Fonts.Default.bold, size: 16)
        ...
        NSLayoutConstraint.activate([
            ...
            notionIcon.leftAnchor.constraint(equalTo:containerView.leftAnchor, constant: 5),
            notionIcon.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -5),
            notionIcon.widthAnchor.constraint(equalToConstant:15),
        ])
        
        countText = UILabel()
        countText.backgroundColor = .clear
        countText.font = UIFont(name: Assets.Fonts.Default.semiBold, size: 14)
        countText.textColor = Settings.Theme.Color.text
        countText.textAlignment = NSTextAlignment.left
        ...
        NSLayoutConstraint.activate([
            countText.topAnchor.constraint(equalTo:title.bottomAnchor, constant: 0),
            countText.leftAnchor.constraint(equalTo:notionIcon.rightAnchor, constant: 0),
