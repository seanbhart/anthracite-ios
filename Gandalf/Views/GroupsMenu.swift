...
protocol GroupsMenuDelegate {
    func loadGroup(group: String)
}

class GroupsMenu: UIViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, GroupRepositoryDelegate {
    let className = "GroupsView"
    
    var delegate: GroupsMenuDelegate!
    ...
    var groupsTableViewSpinner = UIActivityIndicatorView(style: .medium)
...
//            nc.navigationBar.barStyle = Settings.Theme.barStyle
        ...
        NSLayoutConstraint.activate([
            groupsTableView.topAnchor.constraint(equalTo:viewContainer.topAnchor),
            ...
            groupsTableView.bottomAnchor.constraint(equalTo:addContainer.topAnchor, constant: -5),
        ])
...
//    }
    ...
    override func loadView() {
        ...
        groupsTableViewRefreshControl = UIRefreshControl()
        groupsTableViewRefreshControl.tintColor = Settings.Theme.Color.text
        groupsTableViewRefreshControl.addTarget(self, action: #selector(refreshGroups), for: .valueChanged)
        
        groupsTableView = UITableView()
        groupsTableView.dataSource = self
        groupsTableView.delegate = self
        groupsTableView.refreshControl = groupsTableViewRefreshControl
        ...
        groupsTableView.bounces = true
        groupsTableView.alwaysBounceVertical = true
        groupsTableView.showsVerticalScrollIndicator = false
        groupsTableView.isUserInteractionEnabled = true
        groupsTableView.allowsSelection = true
...
//        groupsTableView.insetsContentViewsToSafeArea = true
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(GroupView(group: localGroups[indexPath.row]), animated: true)
    }
    
    func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        if tableView != groupsTableView { return nil }
    ...
    func groupDataUpdate() {
        ...
        groupsTableViewRefreshControl.endRefreshing()
    }
